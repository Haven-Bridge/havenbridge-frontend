  ...
  const navLinks: NavLink[] = [
    {
      ...
      icon: Users,
      dropdown: [
        { name: "Who We Are", href: "/who-we-are", description: "Our story & purpose", icon: Users },
        { name: "Mission & Vision", href: "/mission-vision", description: "What drives us", icon: Target },
        { name: "Our Values", href: "/values", description: "Guiding principles", icon: HeartHandshake },
        { name: "Leadership", href: "/leadership", description: "Our team", icon: UserCircle },
      ],
    },
